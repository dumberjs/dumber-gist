...
scp -r client-app/output/ huocp@dumber.app:dumber-gist/client-app/output/
...
scp server/dumber-cache/app.js huocp@dumber.app:dumber-gist/server/dumber-cache/app.js
scp server/github-oauth/app.js huocp@dumber.app:dumber-gist/server/github-oauth/app.js
